...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="filter-info">Periode Penyaluran: {{ $filters['tgl_mulai'] ?? '...' }} s/d {{ $filters['tgl_akhir'] ?? '...' }}</div>
            @endif
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $row['method'] === 'village_cash' ? 'Tunai' : 'Transfer' }}</td>
                </tr>
                @endforeach
                <tr class="total-row">
                    <td colspan="6" class="text-right"><strong>TOTAL: {{ count($data) }} orang</strong></td>
