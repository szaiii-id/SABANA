...
<head>
    ...
    <style>
        ...
        .badge-pending { background: #fef3c7; color: #92400e; padding: 3px 8px; border-radius: 10px; font-size: 9px; font-weight: bold; }
...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <div class="filter-info">Periode Trigger: {{ $filters['tgl_mulai'] ?? '...' }} s/d {{ $filters['tgl_akhir'] ?? '...' }}</div>
            @endif
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><span class="badge-pending">Akan Dievaluasi</span></td>
                    <td></td>
                </tr>
                @endforeach
                <tr class="total-row">
