...
<head>
    ...
    <style>
        ...
        .badge-assisted { background: #dbeafe; color: #1e40af; }
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $adminRoleLabels[$row['admin_role']] ?? $row['admin_role'] }}</td>
                    <td>
                        @if($row['action'] === 'register_with_pin')
                            <span class="badge badge-personal">Akses Pribadi</span>
                        @else
                            <span class="badge badge-assisted">Bantuan Petugas</span>
                        @endif
                    </td>
                ...
                @endforeach
                <tr class="total-row">
                    <td colspan="7" class="text-center"><strong>TOTAL: {{ count($data) }} warga</strong></td>
                </tr>
            </tbody>
        </table>
