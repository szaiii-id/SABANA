...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Repositories\Contracts\CitizenRepositoryInterface' => \App\Repositories\CitizenRepository::class,
    ...
    override(\config(), map([
            ...
            'auth.providers.citizens.driver' => 'string',
            'auth.providers.citizens.model' => 'string',
            ...
            'services.elasticsearch.hosts' => 'string',
...
'auth.guards.web.provider','auth.providers.users.driver','auth.providers.users.model','auth.providers.citizens.driver','auth.providers.citizens.model',
...
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.elasticsearch.hosts','session.driver','session.lifetime',
...
'passport.authorizations.approve','passport.authorizations.deny','passport.device.authorizations.authorize','passport.device.authorizations.approve','passport.device.authorizations.deny','storage.local',
...
'REDIS_CLIENT','REDIS_HOST','REDIS_PASSWORD','REDIS_PORT','ELASTICSEARCH_HOST',
